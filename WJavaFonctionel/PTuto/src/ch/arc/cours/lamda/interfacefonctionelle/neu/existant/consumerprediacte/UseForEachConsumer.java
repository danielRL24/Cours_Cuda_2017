...
public class UseForEachConsumer
	...
	private static void version2(int n)
		...
		Consumer<Homme> inverseHeight = homme -> homme.opposePoids();
//		Consumer<Homme> inverseHeight = homme -> System.out.println(homme.getHauteur());

		HommeManipulator.foreach(iterable, inverseHeight);
