...
public class UseReduceAddInteger
	...
	private static int version1(int[] tab)
		{
		IntBinaryOperator operatorIntADD = new IntBinaryOperator()
			{
			@Override
		...
		return NumberManipulatorInteger.reduce(tab, operatorIntADD, 0);
		}
	...
	private static int version2(int[] tab)
		{
		IntBinaryOperator operatorIntADD = (x, y) -> x + y;
		return NumberManipulatorInteger.reduce(tab, operatorIntADD, 0);
		}
