...
double piOMPEntrelacerAtomic(int n)
    ...
    # pragma omp parallel shared(sumGlobal) // Variable sumGlobal, optionnel car comportement par défaut
	{
    ...
    # pragma omp atomic // Que le prochaine opérateur mathématique
	sumGlobal += sumLocal;
